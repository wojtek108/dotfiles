---
persona: Beginning Hobby Coder (Python/C), sell automations and ai-based solutions to companies
environment: Ubuntu Linux / mikr.us VPS
shell: bash / zsh
python_version: 3.13
preferred_tools: [uv, apt, pyenv, neovim, n8n]
---

# My Custom Instructions for opencode
