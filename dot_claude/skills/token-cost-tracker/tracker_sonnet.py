#!/usr/bin/env python3
"""Token cost tracker for Claude Sonnet 4.5"""
import json
import sys
...
def format_results(results):
    ...
    return f"""
Token Usage Summary (Sonnet 4.5)
================================
...
def main():
    ...
    if not input_data:
        ...
        print("Token Cost Tracker (Claude Sonnet 4.5)")
        print("=" * 40)
        print("\nUsage: python tracker_sonnet.py '<conversation_data_or_json>'")
